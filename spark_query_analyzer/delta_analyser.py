...
class DeltaFinding:
    ...
    improvement_bytes: int | None = None
...
def analyse_table(spark, table: str, sql_filter_columns: list[str] = None) -> DeltaHealthResult | None:
    """
    ...
    try:
        ...
        result.partition_columns = [
            ...
            if str(r.get('col_name', ''))
            and str(r.get('data_type', '')).startswith('#')
